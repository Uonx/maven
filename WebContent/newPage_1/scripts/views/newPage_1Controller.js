...
//newPage_1、newPage_1在编译时将替换为实际值，设计过程中不要随意修改

newPage_1.views.newPage_1Controller = function() {
	var me = $extend(mx.views.ViewController);
	var base = {};
	me.typeName="newPage_1.views.newPage_1Controller";
	me.getController=function(key){
		return me.getLinkViewController("newPage_1.views."+key+"Controller");
	};
	me.getView = function() {
		if (me.view == null) {
			me.view = new newPage_1.views.newPage_1({ controller: me });
		}
		return me.view;
	};
	/*************公共函数库定义****************************/
